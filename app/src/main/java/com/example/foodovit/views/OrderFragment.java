package com.example.foodovit.views;
...
import com.example.foodovit.databinding.FragmentOrderBinding;
import com.example.foodovit.viewmodels.ShopViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOrderBinding.continueShoppingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_orderFragment_to_paymentActivity3);
            }
        });
